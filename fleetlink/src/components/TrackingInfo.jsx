...
function TrackingInfo() {
  return (
    <div className='grid md:grid-cols-2 grid-cols-1 items-center justify-center p-2 w-[60%] drop-shadow-2xl shadow-2xl h-auto rounded-md bg-white gap-3 text-black'>
