  ...
  return (
    <div className=''>
        <div className='mt-29 w-full h-screen mx-auto text-center flex justify-center'>
            ...
            <div className='bg-white flex flex-col md:w-[350px] w-[250px] md:h-[180px] h-[250px] shadow-lg absolute left-1/2 top-1/2 transform -translate-x-1/2 px-3 py-3 rounded-md ease-in-out duration-500'>
