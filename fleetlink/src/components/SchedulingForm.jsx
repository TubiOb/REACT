    ...
    <div className='flex flex-col w-[95%] md:w-[45%] items-center justify-center mx-auto mt-24 z-10 p-2 gap-4 bg-white h-auto text-black rounded-2xl border outline-none'>
        ...
        <div className='w-[90%] mx-auto p-2 md:p-4 grid grid-cols-1 md:grid-cols-2 items-center justify-between gap-4'>
            <div className='border-none outline-none items-center justify-center mb-2 w-full mx-auto gap-2 inline-flex flex-col'>
                <fieldset className='border-none outline-none w-[40%]'>
                    <legend className='text-neutral-600 font-semibold text-xs ml-2 border-none outline-none'></legend>
                    <Menu as="div" className="relative inline-block w-full text-left">
                        <div className='gap-4'>
                            <Menu.Button className="inline-flex w-full justify-center gap-x-3.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                            Options
