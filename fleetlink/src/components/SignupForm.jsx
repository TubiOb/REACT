  ...
  return (
    <div className='w-full md:w-[50%] h-screen bg-neutral-800 flex flex-col items-center justify-center p-4 relative'>
        <form onSubmit={handleSave} className='mx-auto bg-white outline-none border-none rounded-xl shadow-sm shadow-neutral-50 w-[85%] md:w-[65%] inline-flex flex-col h-auto gap-4 px-2 py-5'>
            <InputFields placeholder='Full Name' onChange={(value) => handleInputChange(value, 'fullName')}/>
            <InputFields placeholder='Email Address' onChange={(value) => handleInputChange(value, 'emailAddress')}/>
            <InputFields placeholder='Phone Number' onChange={(value) => handleInputChange(value, 'phoneNumber')}/>
            <InputFields placeholder='Address' onChange={(value) => handleInputChange(value, 'address')}/>
            <InputFields placeholder='Password' onChange={(value) => handleInputChange(value, 'password')}/>
            <InputFields placeholder='Confirm Password' onChange={(value) => handleInputChange(value, 'confirmPassword')}/>
