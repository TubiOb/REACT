...
const LandingPage = () => {
  ...
  return (
    <div className='h-screen w-full relative bg-neutral-400'>
      ...
      <div className='flex w-[80%] md:w-[50%] mx-auto absolute left-1/2 -translate-x-1/2 top-1/2 md:top-1/3 transform md:translate-y-1/2 -translate-y-1/2 gap-3'>
        <h3 className='text-white font-semibold text-lg md:text-4xl items-center mx-auto justify-center flex'>Connecting Workplaces, One Ride at a Time</h3>
      </div>
      ...
      <div className='bg-white w-full h-[30%] md:h-[40%] md:rounded-tl-3xl rounded-tr-3xl fixed bottom-0 left-0 py-5 md:py-9 px-4 flex flex-col'>
        ...
        <div className='flex flex-row-reverse md:hidden p-2 '>
          <div className='flex flex-row gap-1.5 hover:underline'>
