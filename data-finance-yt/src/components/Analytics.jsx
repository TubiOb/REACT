  ...
  return (
    <div className='w-full bg-white py-16 px-4'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='fkex flex-col justify-center'>
                ...
                <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto nd:mx-0 py-3'>Get Started</button>
            </div>
        </div>
    </div>
  );
