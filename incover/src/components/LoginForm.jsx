    ...
    <div className='grid grid-cols-1 items-center justify-between w-70% mx-auto gap-8'>
      ...
      {showPassword && (
        <div className='grid grid-cols-1 items-center justify-between w-70% ml-0 mx-auto gap-8'>
          ...
          <button onClick={handleLoginClick} className='rounded-md py-2 px-4 text-white outline-none border-none bg-green-700 hover:bg-green-800 transition ease-in-out'><Link to='/dashboard'>Sign in</Link></button>
