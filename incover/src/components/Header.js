  ...
  return (
    <header className='text-green-600'>
        <div className='w-full border-b border-b-gray-200 h-auto flex p-4 px-9 items-center justify-between'>
            <Link to="/login"><div className="BoiInsBroker1 w-[306.24px] h-14 md:flex relative hidden cursor-pointer">
                <img src={logo} alt="BOI Ins Broker logo" className='outline-none border-none w-[150px] md:w-[200px]' />
            </div></Link>
